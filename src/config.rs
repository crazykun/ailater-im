...
fn default_max_preedit() -> usize { 64 }
fn default_num_candidates() -> usize { 10 }
fn default_page_size() -> usize { 5 }
fn default_min_ai_input() -> usize { 2 }
...
fn default_system_dict() -> String { "/usr/share/ailater-im/dict/system.dict".to_string() }
fn default_user_dict() -> String { "~/.local/share/ailater-im/user.dict".to_string() }
fn default_user_dict_size() -> usize { 100000 }
fn default_decay_factor() -> f32 { 0.99 }
